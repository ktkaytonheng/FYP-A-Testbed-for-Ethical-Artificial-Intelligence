...
public class WanderAI : MonoBehaviour
{
    ...
    void Start()
    {
        gameVariables = transform.parent.parent.Find("GameVariables").GetComponent<GameVariables>();
        ...
        transform.rotation = Quaternion.Euler(0,Random.Range(-180.0f, 180.0f), 0);
        ...
        if (gameVariables.trainingMode) SetWorth();
    }
